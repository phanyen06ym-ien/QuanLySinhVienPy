...
class AdminForm:
    ...
    def on_select_sv(self, event):
        ...
        if sel:
            ...
            self.sv_sdt.insert(0, v[4])

            self.sv_diachi.delete(0, tk.END)
            self.sv_diachi.insert(0, v[5])

            self.sv_namthu.delete(0, tk.END)
            self.sv_namthu.insert(0, v[6])

            self.sv_khoahoc.delete(0, tk.END)
            self.sv_khoahoc.insert(0, v[7])

            self.sv_lop.delete(0, tk.END)
            self.sv_lop.insert(0, v[8])
